        ...
        <div className="container px-4 md:px-6 mx-auto max-w-5xl">
          ...
          >
            ...
            <motion.section variants={itemVariants} className="space-y-6">
              ...
              <Card className="border-none shadow-xl bg-slate-100 overflow-hidden">
                <CardContent className="p-8 md:p-10">
                  <div className="space-y-8">
                    <div className="flex gap-6 items-center border-b border-slate-200 pb-6">
            ...
            <motion.section variants={itemVariants} className="space-y-6">
              ...
              <div className="bg-slate-100 text-slate-600 p-8 rounded-3xl text-center">
                <p className="text-sm">
