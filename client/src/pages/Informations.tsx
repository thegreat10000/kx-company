...
export default function Informations() {
  ...
  return (
    <div className="min-h-screen bg-background dark:bg-slate-950 flex flex-col transition-colors duration-300">
      <Header />
      <main className="flex-1 pb-16 md:pb-24 bg-slate-50/30 dark:bg-slate-900/20">
        {/* Hero Section with pleasant background */}
        <section className="bg-[#FFB7D5] dark:bg-[#4A1D2F] py-16 md:py-24 mb-12 transition-colors duration-500">
          <div className="container px-4 md:px-6 mx-auto max-w-5xl text-center">
            <h1 className="font-display text-4xl md:text-6xl font-extrabold mb-6 tracking-tight text-slate-900 dark:text-pink-100">
        ...
        <div className="container px-4 md:px-6 mx-auto max-w-5xl">
          ...
          >
            ...
            <motion.section variants={itemVariants} className="space-y-6">
              ...
              <Card className="border-none shadow-xl bg-white dark:bg-slate-900/50 dark:border dark:border-slate-800 overflow-hidden">
                <CardContent className="p-8 md:p-10">
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <li className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="font-bold text-lg mb-1 dark:text-slate-200">Justificatif de domicile</h3>
                        <p className="text-slate-500 dark:text-slate-400">De moins de 3 mois obligatoire.</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-4">
                      <div className="bg-slate-100 dark:bg-slate-800 p-3 rounded-xl text-slate-600 dark:text-slate-400">
            ...
            <motion.section variants={itemVariants} className="space-y-6">
              ...
              <Card className="border-none shadow-xl bg-slate-100 dark:bg-slate-800/40 overflow-hidden">
                <CardContent className="p-8 md:p-10">
            ...
            <motion.section variants={itemVariants} className="space-y-6">
              ...
              <Card className="border-none shadow-xl bg-white dark:bg-slate-900/50 overflow-hidden">
                <CardContent className="p-8 md:p-10 space-y-8">
                  ...
                  <div className="flex flex-col md:flex-row gap-8 items-center bg-primary/5 dark:bg-primary/10 p-8 rounded-2xl border border-primary/10 dark:border-primary/20">
                    <div className="text-center md:text-left flex-1">
                      <h3 className="text-xl font-bold mb-2 dark:text-slate-200">Montant de la réservation</h3>
                    ...
                    <div className="text-center md:text-left flex-1">
                      <h3 className="text-xl font-bold mb-2 text-red-600 dark:text-red-400">En cas d'annulation</h3>
                      <p className="text-slate-600 dark:text-slate-400">
            ...
            <motion.section variants={itemVariants} className="space-y-6">
                ...
                <Card className="border-none shadow-xl bg-white dark:bg-slate-900/50 overflow-hidden">
                  <CardContent className="p-8">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <h3 className="font-bold text-lg dark:text-slate-200">Carburant</h3>
                    </div>
                    <p className="text-slate-600 dark:text-slate-400 mb-4">
                      Véhicule fourni avec le plein de carburant. Il doit être rendu avec le plein.
                    </p>
                    <div className="bg-primary text-white px-4 py-2 rounded-full inline-block font-bold text-sm shadow-lg shadow-primary/20">
                      SP98 UNIQUEMENT
                    </div>
                  </CardContent>
                </Card>
                <Card className="border-none shadow-xl bg-white dark:bg-slate-900/50 overflow-hidden">
                  <CardContent className="p-8">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <h3 className="font-bold text-lg dark:text-slate-200">Propreté</h3>
                    </div>
                    <p className="text-slate-600 dark:text-slate-400">
              ...
              <div className="bg-slate-100 dark:bg-slate-800/80 text-slate-600 dark:text-slate-300 p-8 rounded-3xl text-center border border-slate-200 dark:border-slate-700 shadow-inner">
