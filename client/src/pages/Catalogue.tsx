                              ...
                              <CarouselItem key={index}>
                                <div className="aspect-video relative rounded-lg overflow-hidden">
                                  <img
                                    ...
                                    className="object-cover w-full h-full"
                                    style={(selectedCar.model === "Renault Clio V Alpine" && index < 3) ? { objectPosition: "center 75%" } : (selectedCar.model === "Peugeot 208 GT" && index < 6) ? { objectPosition: index === 2 ? "center 72%" : (index >= 1 && index <= 3) ? "center 75%" : "center 65%" } : undefined}
                                  />
                                </div>
                              </CarouselItem>
                            ))}
