                    ...
                    <CarouselItem key={index} className="h-full">
                      <div className="relative h-full w-full">
                        <img 
                          ...
                          style={(car.model === "Renault Clio V Alpine" && index < 3) ? { objectPosition: "center 75%" } : (car.model === "Peugeot 208 GT" && index < 6) ? { objectPosition: index === 2 ? "center 68%" : (index >= 1 && index <= 3) ? "center 75%" : "center 65%" } : undefined}
                        />
                      </div>
                    </CarouselItem>
                  ))}
